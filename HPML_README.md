...
- `hpml_testing/run_hetero_benchmark.sh`
    Contains script for testing 4 methods of splitting Qs in simulated heterogenous GPUs.
- `hpml_testing/benchmark_hetero_latency.py`
    Script which is called by shell script above.

## Current Progress
- Implemented Triton kernel for ring attention with online softmax. Benchmarked one Multi Head Attention layer with 4 different methods for splitting queries on simulated heterogenous GPUs.
