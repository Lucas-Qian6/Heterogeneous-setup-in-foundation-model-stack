...
Based on our findings, we recommend that distributed inference frameworks incorporate heterogeneity-aware partitioning as a first-class feature. The simplicity and effectiveness of proportional allocation makes it a low-cost addition to existing implementations. Future work should extend these techniques to multi-node deployments and investigate dynamic adaptation to runtime performance variations.
